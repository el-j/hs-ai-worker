...
async def sync_bot_commands(target):
    ...
    commands = [
        ...
        BotCommand("selftest", "🩺 Full health check: gateway, disk, version"),
        BotCommand("selfheal", "🩹 Diagnose problems & get the fix command"),
        BotCommand("update", "🔄 Check how far behind the latest version"),
