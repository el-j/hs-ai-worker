...
mirrors topics.py's binding-file pattern exactly.
"""
...
def get_task_session(chat_id: int, thread_id: int | None) -> dict | None:
...
def set_task_session(chat_id: int, thread_id: int | None, project: str, session_id: str, branch: str):
...
def clear_task_session(chat_id: int, thread_id: int | None):
